...
Pod::Spec.new do |s|
  s.name             = 'HLClock'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HLClock.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/HLClock'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Stephen Spalding' => 'sspalding@opentable.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/HLClock.git', :tag => s.version.to_s }
